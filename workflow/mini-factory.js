...
Write PLAN.md with the heading "# ${goal}" followed by a blank line and this
plan verbatim:

${plan}

Then check out a new branch named factory/<something short and descriptive
derived from the goal>, stage everything, and commit with the message
