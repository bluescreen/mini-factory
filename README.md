...
|---|---|---|---|
| 1 | [Das leere Projekt](#1-das-leere-projekt) | 5 min | `npm test` — und es gibt nichts zu testen |
| 2 | [Der Planner](#2-der-planner) | 10 min | einen Plan erzeugen und nachlesen |
| 3 | [Der Builder](#3-der-builder) | 10 min | Dateien entstehen lassen — ungeprüft |
| 4 | [Die Übergabe](#4-die-übergabe) | 5 min | sehen, wie der Plan beim Builder ankommt |
| 5 | [Das Gate und der Rücksprung](#5-das-gate-und-der-rücksprung) | 12 min | rot → zurück an Build → grün |
| 6 | [Der Review](#61-der-review) | 10 min | ein zweites Gate — gegen das Ziel statt gegen den Lauf |
| 7 | [Der Commit und die Rechnung](#7-der-commit-und-die-rechnung) | 8 min | einen Branch und den Preis des Laufs |
| 8 | [Der Review fächert auf](#8-der-review-fächert-auf-optional) | +12 min | **optional** — drei Lenses gleichzeitig, Mehrheit entscheidet |
...
auschecken, alles stagen, mit "feat: <goal>" committen, als NN-commit.json
ablegen und "NN  CODE  commit  <branch>" loggen.
